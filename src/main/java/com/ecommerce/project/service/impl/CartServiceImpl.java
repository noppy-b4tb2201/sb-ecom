...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if(cartItem != null) {
            throw new APIException("Product " + product.getProductName() + "already exisys in Cart");
        }
        ...
        if (product.getQuantity() < quantity) {
            throw new APIException(product.getProductName() + "less than or equal to the quantity");
        }
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer delete) {
        ...
        int newQuantity = cartItem.getQuantity() + delete;
